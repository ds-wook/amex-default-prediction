...
def create_avg_features(df: pd.DataFrame, config: DictConfig) -> pd.DataFrame:
    ...
    logging.info("Complete avg features")
    ...
    logging.info("Complete max features")
    ...
    logging.info("Complete min features")
    ...
    logging.info("Complete last features")
    ...
    logging.info("complete concat")

    return df, target if config.dataset.is_train else df
